...
// Try and catch blocks validate the file import name
public class CourseList {
    ...
    public void loadSections() {
        ...
        try {
            ...
            System.out.print("Error while loading the course sections. The specified file name does not exist. Please restart and correct the file name.\n");
        }
    ...
    public void findCrn() {
        ...
        try {
            ...
            System.out.print("Error while loading the course search. The specified file name does not exist. Please restart and correct the file name.\n");
        }
